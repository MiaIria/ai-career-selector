...
export const QUESTION_GROUPS: Record<QuestionnaireGroup, ProfileQuestion[]> = {
  ...
  public: [
    { id: "public_reason", prompt: "你想考公是因为：", options: ["享受为人民服务带来的幸福感", "为了一份稳定的工作", "家里人支持并且有条件帮助我", "相较于考研和就业来说更愿意考公"] },
    ...
    { id: "public_preparedness", prompt: "如果没有上岸你的选择是？", options: ["无脑二战", "转向事业单位、央国企等其他稳定路径", "普通就业、升学等其他路径", "没有明确计划，考完再说"] },
    { id: "public_top_rank_count", prompt: "小学到大学期间总成绩得过班级第一的次数是？", options: ["5次及以上", "1-5次", "0次"] },
  ...
  employment: [
    ...
    { id: "employment_capital", prompt: "你目前最拿得出手的求职资本是：", options: ["实习、项目或作品集", "专业技能或证书", "表达能力与执行力", "还没有特别明确的东西"], multiple: true },
    { id: "employment_growth", prompt: "如果第一份工作工资不高，但能积累很多技能，你愿意继续工作吗？", options: ["愿意，前两年重在积累能力", "如果工作内容是我喜欢的话，我愿意", "不太愿意，我更看重收入", "不愿意，我只要钱"] },
    ...
    { id: "employment_pressure", prompt: "你对工作强度、职场压力的看法是", options: ["只要工资够高，996也没问题", "只能适应早9晚6", "不能适应早9晚6"] },
